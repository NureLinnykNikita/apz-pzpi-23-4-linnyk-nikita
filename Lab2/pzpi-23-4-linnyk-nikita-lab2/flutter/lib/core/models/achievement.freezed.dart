...
class _$AchievementImpl implements _Achievement {
  ...
  @override
  String toString() {
    return 'Achievement(achievementId: $achievementId, code: $code, title: $title, description: $description, iconUrl: $iconUrl, earnedAt: $earnedAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, achievementId, code, title, description, iconUrl, earnedAt);
...
abstract class _Achievement implements Achievement {
  const factory _Achievement(
      {required final int achievementId,
